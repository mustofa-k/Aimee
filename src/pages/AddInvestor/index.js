...
const AddInvestor = ({ navigation }) => {
  ...
  const sektorIndustriList = [
    ...
    { label: 'Consultant Services', value: 'Consultant Services' },
    {
      ...
      value: 'Digital Business Development',
    },
    ...
    {
      label: 'Graphic Design and Creative',
      value: 'Graphic Design and Creative',
    },
    ...
    {
      label: 'Technology and Information',
      value: 'Technology and Information',
    },
  ...
  return (
    <>
      ...
      >
        ...
        />
        <Appbar.Content title="AddInvestor" />
      </Appbar.Header>
      <ScrollView>
        <Container mt={8}>
          <TextInput
